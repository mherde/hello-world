...
public interface Document extends Iterable<String> {
	 ...
	 * 
	 * @return Iterator, that contains each occurring String <b>exactly once</b>. 
	 */
	 ...
	 * 
	 * @param input the stream of the original document
	 * @throws IOException
	 */
	...
	/**
	 * Return all positions, where a given term occurs (starting with 0, ordered from earlies to last)
	 * 
	 * @param term
	...
	/**
	 * Number of terms (each counted according to its number of occurrences) in the document
	 * 
